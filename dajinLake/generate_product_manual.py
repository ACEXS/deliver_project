...
try:
    doc.add_picture('images/index-page-2026-03-27T16-08-32-968Z.png', width=Inches(6))
...
try:
    doc.add_picture('images/products-page-2026-03-27T16-08-47-995Z.png', width=Inches(6))
except Exception as e:
    doc.add_paragraph(f'图片加载失败: {e}')
...
try:
    doc.add_picture('images/product-detail-page-2026-03-27T16-09-01-334Z.png', width=Inches(6))
except Exception as e:
    doc.add_paragraph(f'图片加载失败: {e}')
...
try:
    doc.add_picture('images/cart-page-2026-03-27T16-10-51-236Z.png', width=Inches(6))
except Exception as e:
    doc.add_paragraph(f'图片加载失败: {e}')
...
try:
    doc.add_picture('images/checkout-page-2026-03-27T16-11-01-587Z.png', width=Inches(6))
except Exception as e:
    doc.add_paragraph(f'图片加载失败: {e}')
...
try:
    doc.add_picture('images/about-page-2026-03-27T16-11-10-772Z.png', width=Inches(6))
except Exception as e:
    doc.add_paragraph(f'图片加载失败: {e}')
...
try:
    doc.add_picture('images/contact-page-2026-03-27T16-09-11-384Z.png', width=Inches(6))
except Exception as e:
    doc.add_paragraph(f'图片加载失败: {e}')
...
try:
    doc.add_picture('images/login-page-2026-03-27T16-10-41-873Z.png', width=Inches(6))
except Exception as e:
    doc.add_paragraph(f'图片加载失败: {e}')
