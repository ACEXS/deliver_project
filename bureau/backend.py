...
projects = [
    {
        ...
        "implementationProcess": [
            "2026年3-4月：完成土地平整与规划，确定种植区域和灌溉系统布局",
            "2026年4-5月：完成灌溉系统设计与安装，采购有机种子",
            "2026年5月：完成春季播种，开展种植技术培训",
            "2026年6-10月：进行病虫害绿色防治和夏季田间管理",
            "2026年11-12月：秋季收获，进行产品质量检测",
            "2027年1-3月：产品加工与包装，品牌注册与推广"
        ],
        "completedItems": [
            "土地平整与规划",
            "灌溉系统设计与安装",
        ...
        "tasks": [
            ...
            {"id": "T001-02", "name": "灌溉系统设计与安装", "status": "已完成", "percentage": 100, "startDate": "2026-04-16", "endDate": "2026-05-15", "responsible": "县农业局技术团队"},
            {"id": "T001-03", "name": "有机种子采购", "status": "已完成", "percentage": 100, "startDate": "2026-05-01", "endDate": "2026-05-15", "responsible": "张木生"},
            {"id": "T001-04", "name": "春季播种", "status": "已完成", "percentage": 100, "startDate": "2026-05-16", "endDate": "2026-05-31", "responsible": "林德发、吴德福"},
            {"id": "T001-05", "name": "病虫害绿色防治", "status": "进行中", "percentage": 70, "startDate": "2026-06-01", "endDate": "2026-10-31", "responsible": "县植保站"},
            {"id": "T001-06", "name": "夏季田间管理", "status": "进行中", "percentage": 50, "startDate": "2026-07-01", "endDate": "2026-10-31", "responsible": "林德发、吴德福"},
